...
def stage_job_resources(options,
                        file_copy=_dependency_file_copy,
                        file_download=_dependency_file_download,
  ...
  file_helper.file_copy = file_copy
  pipeline_stager = stager.Stager(file_helper=file_helper)
  return pipeline_stager.stage_job_resources(
      options, build_setup_args=build_setup_args,
      staging_location=google_cloud_options.staging_location, temp_dir=temp_dir)
