...
from apache_beam.runners.dataflow.internal import dependency, stager
...
class SetupTest(unittest.TestCase):
  ...
  def test_sdk_location_gcs(self):
    ...
    self.assertEqual(
        ...
        dependency.stage_job_resources(
            options,
            file_copy=self.asserting_file_copy(sdk_location, staging_dir)))
  ...
  def test_with_extra_packages(self):
    ...
    self.assertEqual(
        ...
        dependency.stage_job_resources(options, file_copy=file_copy))
